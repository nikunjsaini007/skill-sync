        ...
        <div className="absolute top-4 right-4 flex gap-2">
          {isOwnProfile && onEditProfile && (
            <button
              ...
              className="bg-brand-card/80 backdrop-blur text-slate-200 border border-brand-border text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1.5 shadow-lg hover:border-brand-primary hover:text-white transition-all cursor-pointer transform active:scale-95"
            >
