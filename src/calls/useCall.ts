...
import type { CallData, CallRole, CallStatus, CallType } from "../types";
import {
...
function describeSignalingError(error: unknown, operation: string): string {
